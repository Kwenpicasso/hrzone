...
<strong className="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
      ...
      <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
        <div className="mx-auto w-[80%] lg:max-w-none">
          <CardTitle className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg font-medium">
          Empower your workforce with our comprehensive HR solutions. From recruitment and onboarding to employee engagement and payroll management, we provide the tools and expertise to streamline your HR processes and drive business success. Let's build a better workplace together.
          </CardTitle>
